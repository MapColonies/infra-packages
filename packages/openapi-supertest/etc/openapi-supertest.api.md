## API Report File for "@map-colonies/openapi-supertest"
...
//
// src/types.ts:86:5 - (ae-forgotten-export) The symbol "SendRequest" needs to be exported by the entry point index.d.ts
