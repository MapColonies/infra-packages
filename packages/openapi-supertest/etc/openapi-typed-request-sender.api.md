...
// Warning: (ae-forgotten-export) The symbol "RequestSenderOptions" needs to be exported by the entry point index.d.ts
//
// @public
...
// Warning: (ae-forgotten-export) The symbol "OperationsNames" needs to be exported by the entry point index.d.ts
...
//
// src/types.ts:89:5 - (ae-forgotten-export) The symbol "SendRequest" needs to be exported by the entry point index.d.ts
