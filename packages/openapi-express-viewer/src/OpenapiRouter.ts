...
/**
 * @public
 * Configuration interface for OpenapiViewerRouter.
 */
 ...
 *
 * @remarks
 * The router must be setup using the setup() method before it can be used.
...
export class OpenapiViewerRouter {
   ...
   *
   * @throws If setup is called more than once on the same instance
   *
   ...
   * @throws When called before running setup
   */
