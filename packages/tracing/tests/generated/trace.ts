...
// @generated from protobuf file "trace.proto" (package "opentelemetry.proto.trace.v1", syntax proto3)
/* eslint-disable */
// @ts-nocheck
//
...
class TracesData$Type extends MessageType<TracesData> {
  constructor() {
    super('opentelemetry.proto.trace.v1.TracesData', [
      { no: 1, name: 'resource_spans', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => ResourceSpans },
    ]);
  }
  create(value?: PartialMessage<TracesData>): TracesData {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.resourceSpans = [];
    if (value !== undefined) reflectionMergePartial<TracesData>(this, message, value);
    return message;
  }
...
class ResourceSpans$Type extends MessageType<ResourceSpans> {
  constructor() {
    super('opentelemetry.proto.trace.v1.ResourceSpans', [
      ...
      { no: 2, name: 'scope_spans', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => ScopeSpans },
  ...
  create(value?: PartialMessage<ResourceSpans>): ResourceSpans {
    ...
    message.scopeSpans = [];
    message.schemaUrl = '';
    if (value !== undefined) reflectionMergePartial<ResourceSpans>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: ResourceSpans, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* string schema_url = 3; */
    if (message.schemaUrl !== '') writer.tag(3, WireType.LengthDelimited).string(message.schemaUrl);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ScopeSpans$Type extends MessageType<ScopeSpans> {
  ...
  create(value?: PartialMessage<ScopeSpans>): ScopeSpans {
    ...
    message.spans = [];
    message.schemaUrl = '';
    if (value !== undefined) reflectionMergePartial<ScopeSpans>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: ScopeSpans, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.scope) InstrumentationScope.internalBinaryWrite(message.scope, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class Span$Type extends MessageType<Span> {
  constructor() {
    super('opentelemetry.proto.trace.v1.Span', [
      ...
      { no: 11, name: 'events', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => Span_Event },
      { no: 12, name: 'dropped_events_count', kind: 'scalar', T: 13 /*ScalarType.UINT32*/ },
      { no: 13, name: 'links', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => Span_Link },
  ...
  create(value?: PartialMessage<Span>): Span {
    ...
    message.traceState = '';
    message.parentSpanId = new Uint8Array(0);
    message.flags = 0;
    message.name = '';
    message.kind = 0;
  ...
  internalBinaryWrite(message: Span, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* bytes trace_id = 1; */
    if (message.traceId.length) writer.tag(1, WireType.LengthDelimited).bytes(message.traceId);
    /* bytes span_id = 2; */
    if (message.spanId.length) writer.tag(2, WireType.LengthDelimited).bytes(message.spanId);
    /* string trace_state = 3; */
    if (message.traceState !== '') writer.tag(3, WireType.LengthDelimited).string(message.traceState);
    /* bytes parent_span_id = 4; */
    if (message.parentSpanId.length) writer.tag(4, WireType.LengthDelimited).bytes(message.parentSpanId);
    /* string name = 5; */
    ...
    if (message.kind !== 0) writer.tag(6, WireType.Varint).int32(message.kind);
    /* fixed64 start_time_unix_nano = 7; */
    if (message.startTimeUnixNano !== 0n) writer.tag(7, WireType.Bit64).fixed64(message.startTimeUnixNano);
    /* fixed64 end_time_unix_nano = 8; */
    if (message.endTimeUnixNano !== 0n) writer.tag(8, WireType.Bit64).fixed64(message.endTimeUnixNano);
    ...
    if (message.droppedAttributesCount !== 0) writer.tag(10, WireType.Varint).uint32(message.droppedAttributesCount);
    ...
    if (message.droppedEventsCount !== 0) writer.tag(12, WireType.Varint).uint32(message.droppedEventsCount);
    ...
    if (message.droppedLinksCount !== 0) writer.tag(14, WireType.Varint).uint32(message.droppedLinksCount);
    /* opentelemetry.proto.trace.v1.Status status = 15; */
    if (message.status) Status.internalBinaryWrite(message.status, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
    /* fixed32 flags = 16; */
    if (message.flags !== 0) writer.tag(16, WireType.Bit32).fixed32(message.flags);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Span_Event$Type extends MessageType<Span_Event> {
  ...
  create(value?: PartialMessage<Span_Event>): Span_Event {
    ...
    message.attributes = [];
    message.droppedAttributesCount = 0;
    if (value !== undefined) reflectionMergePartial<Span_Event>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: Span_Event, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.timeUnixNano !== 0n) writer.tag(1, WireType.Bit64).fixed64(message.timeUnixNano);
    /* string name = 2; */
    ...
    if (message.droppedAttributesCount !== 0) writer.tag(4, WireType.Varint).uint32(message.droppedAttributesCount);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Span_Link$Type extends MessageType<Span_Link> {
  constructor() {
    super('opentelemetry.proto.trace.v1.Span.Link', [
      ...
      { no: 2, name: 'span_id', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
      { no: 3, name: 'trace_state', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      { no: 4, name: 'attributes', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => KeyValue },
  ...
  create(value?: PartialMessage<Span_Link>): Span_Link {
    ...
    message.droppedAttributesCount = 0;
    message.flags = 0;
    if (value !== undefined) reflectionMergePartial<Span_Link>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: Span_Link, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.droppedAttributesCount !== 0) writer.tag(5, WireType.Varint).uint32(message.droppedAttributesCount);
    /* fixed32 flags = 6; */
    if (message.flags !== 0) writer.tag(6, WireType.Bit32).fixed32(message.flags);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Status$Type extends MessageType<Status> {
  ...
  internalBinaryWrite(message: Status, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.code !== 0) writer.tag(3, WireType.Varint).int32(message.code);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
