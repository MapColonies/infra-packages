...
// @generated from protobuf file "common.proto" (package "opentelemetry.proto.common.v1", syntax proto3)
/* eslint-disable */
// @ts-nocheck
//
...
class AnyValue$Type extends MessageType<AnyValue> {
  ...
  create(value?: PartialMessage<AnyValue>): AnyValue {
    ...
    if (value !== undefined) reflectionMergePartial<AnyValue>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: AnyValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.value.oneofKind === 'stringValue') writer.tag(1, WireType.LengthDelimited).string(message.value.stringValue);
    /* bool bool_value = 2; */
    if (message.value.oneofKind === 'boolValue') writer.tag(2, WireType.Varint).bool(message.value.boolValue);
    /* int64 int_value = 3; */
    if (message.value.oneofKind === 'intValue') writer.tag(3, WireType.Varint).int64(message.value.intValue);
    /* double double_value = 4; */
    if (message.value.oneofKind === 'doubleValue') writer.tag(4, WireType.Bit64).double(message.value.doubleValue);
    ...
    /* bytes bytes_value = 7; */
    if (message.value.oneofKind === 'bytesValue') writer.tag(7, WireType.LengthDelimited).bytes(message.value.bytesValue);
...
class KeyValueList$Type extends MessageType<KeyValueList> {
  ...
  create(value?: PartialMessage<KeyValueList>): KeyValueList {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.values = [];
    if (value !== undefined) reflectionMergePartial<KeyValueList>(this, message, value);
    return message;
  }
...
class KeyValue$Type extends MessageType<KeyValue> {
  ...
  internalBinaryWrite(message: KeyValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.value) AnyValue.internalBinaryWrite(message.value, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class InstrumentationScope$Type extends MessageType<InstrumentationScope> {
  ...
  create(value?: PartialMessage<InstrumentationScope>): InstrumentationScope {
    ...
    if (value !== undefined) reflectionMergePartial<InstrumentationScope>(this, message, value);
    return message;
  }
...
class EntityRef$Type extends MessageType<EntityRef> {
  constructor() {
    super('opentelemetry.proto.common.v1.EntityRef', [
      { no: 1, name: 'schema_url', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      { no: 2, name: 'type', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      { no: 3, name: 'id_keys', kind: 'scalar', repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
      { no: 4, name: 'description_keys', kind: 'scalar', repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
    ]);
  }
  create(value?: PartialMessage<EntityRef>): EntityRef {
    ...
    if (value !== undefined) reflectionMergePartial<EntityRef>(this, message, value);
    return message;
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* string type */ 2:
          ...
          break;
        case /* repeated string id_keys */ 3:
          message.idKeys.push(reader.string());
          break;
        case /* repeated string description_keys */ 4:
  ...
  internalBinaryWrite(message: EntityRef, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* string schema_url = 1; */
    if (message.schemaUrl !== '') writer.tag(1, WireType.LengthDelimited).string(message.schemaUrl);
    /* string type = 2; */
    if (message.type !== '') writer.tag(2, WireType.LengthDelimited).string(message.type);
    /* repeated string id_keys = 3; */
    for (let i = 0; i < message.idKeys.length; i++) writer.tag(3, WireType.LengthDelimited).string(message.idKeys[i]);
    /* repeated string description_keys = 4; */
    for (let i = 0; i < message.descriptionKeys.length; i++) writer.tag(4, WireType.LengthDelimited).string(message.descriptionKeys[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
/**
 * @generated MessageType for protobuf message opentelemetry.proto.common.v1.EntityRef
 */
