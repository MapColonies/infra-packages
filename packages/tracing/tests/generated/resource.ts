...
// @generated from protobuf file "resource.proto" (package "opentelemetry.proto.resource.v1", syntax proto3)
/* eslint-disable */
// @ts-nocheck
//
...
class Resource$Type extends MessageType<Resource> {
  constructor() {
    super('opentelemetry.proto.resource.v1.Resource', [
      ...
      { no: 3, name: 'entity_refs', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => EntityRef },
    ]);
  }
  create(value?: PartialMessage<Resource>): Resource {
    ...
    message.entityRefs = [];
    if (value !== undefined) reflectionMergePartial<Resource>(this, message, value);
    return message;
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* uint32 dropped_attributes_count */ 2:
          ...
          break;
        case /* repeated opentelemetry.proto.common.v1.EntityRef entity_refs */ 3:
          message.entityRefs.push(EntityRef.internalBinaryRead(reader, reader.uint32(), options));
          break;
        default:
  ...
  internalBinaryWrite(message: Resource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.droppedAttributesCount !== 0) writer.tag(2, WireType.Varint).uint32(message.droppedAttributesCount);
    /* repeated opentelemetry.proto.common.v1.EntityRef entity_refs = 3; */
    for (let i = 0; i < message.entityRefs.length; i++)
      EntityRef.internalBinaryWrite(message.entityRefs[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
