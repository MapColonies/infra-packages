...
program.addHelpText(
  ...
  `
Examples:
  $ openapi-generators generate types api.yaml types.ts
  $ openapi-generators generate types api.yaml types.ts --format
  $ openapi-generators generate types api.yaml types.ts --add-typed-request-handler
  $ openapi-generators generate types api.yaml types.ts --add-typed-request-handler --format
  $ openapi-generators generate errors api.yaml errors.ts
  $ openapi-generators generate errors api.yaml errors.ts --format
  $ openapi-generators generate errors api.yaml errors.ts --no-mapping
  $ openapi-generators generate errors api.yaml errors.ts --no-error-classes
  $ openapi-generators generate errors api.yaml errors.ts --no-mapping --no-error-classes
  $ openapi-generators --help
  $ openapi-generators generate --help
  $ openapi-generators generate types --help
  $ openapi-generators generate errors --help
`
);
